...
def get_args():
    ...
    misc_args.add_argument("-d","--data",type=str,default="SBD", help="{SBD, VOC2012, HYBRID}, HYBRID if you want SBD as training and VOC2012 as validation")
    misc_args.add_argument("--data_path",type=str,default="../data/benchmark_RELEASE/")
    misc_args.add_argument("--val_data_path", type=str, default="../data/VOCdevkit/",help="only if using 'HYBRID' in '--data'")
